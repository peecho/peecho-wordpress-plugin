...
class Peecho_Help
{
    ...
    public function tabs()
    {
        ...
        $screen->add_help_tab(
            ...
            'title'   => __('Usage', Peecho::TEXT_DOMAIN),
        ...
        $screen->add_help_tab(
            array(
            'id'      => 'post-plugin-help',
            'title'   => __('Post Editor', Peecho::TEXT_DOMAIN),
        ...
        if (!defined('POST_SNIPPETS_DISABLE_PHP')) {
            $screen->add_help_tab(
                array(
                'id'      => 'php-plugin-help',
                'title'   => __('PHP', Peecho::TEXT_DOMAIN),
        ...
        $screen->add_help_tab(
            ...
            'title'   => __('Advanced', Peecho::TEXT_DOMAIN),
        ...
        $screen->add_help_tab(
            ...
            'title'   => __('Filters', Peecho::TEXT_DOMAIN),
        ...
        $screen->add_help_tab(
            ...
            'title'   => __('Translators', Peecho::TEXT_DOMAIN),
    ...
    {
        return Peecho_View::render(
            $tab,
            array('td' => Peecho::TEXT_DOMAIN)
        );
    }
}
